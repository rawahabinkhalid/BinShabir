...
include_once('conn.php');
                    ...
                    $varieties = ["Final", "Short grain", "B1", "B2", "B3", "CSR", "Broken CSR", "Peddy", "Powder", "Choba", "Sweeping", "Stones"];
                                ...
                                $sql = 'SELECT  toolmillcontract.ContractNo, SaleCustomerName, ProcessingMill, Quality, Variety, 
                                                ...
                                                WHERE gatepass_g_recieved_items.Type = "Rice" AND toolmillcontract.ContractNo = "'.$_POST['contractNo'].'"
                                                GROUP BY ContractNo';
                                ...
                                $sql = 'SELECT  creditor.ContractNo, PurchaseSupplierName, Quality, Variety, 
                                                ...
                                                JOIN gatepass_g_recieved_items ON gatepass_g_recieved.Id = gatepass_g_recieved_items.GoodReceivedId
                                                WHERE gatepass_g_recieved_items.Type = "Rice" AND creditor.ContractNo = "'.$_POST['contractNo'].'"
                                                GROUP BY ContractNo';
                                ...
                                $sql = 'SELECT  debtor.ContractNo, SaleCustomerName, Quality, Variety, 
                                                ...
                                                JOIN gatepass_g_recieved_items ON gatepass_g_recieved.Id = gatepass_g_recieved_items.GoodReceivedId
                                                WHERE gatepass_g_recieved_items.Type = "Rice" AND debtor.ContractNo = "'.$_POST['contractNo'].'"
                                                GROUP BY ContractNo';
