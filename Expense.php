...
<head>
    <meta charset="utf-8">
    <title>Self Manufacturing Expense - Dashboard</title>
...
<body>
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Self Manufacturing Expense</li>
                                </ol>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    <h3 style="color: #7088C8"><u>Expense:</u></h3>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php
                                    $sql = 'SELECT MAX(Id) as maxid FROM expense';
                                    ...
                                    echo'
                                    <input type="number" name="productionNo" value="'.$count++.'" id=""
    ...
    <script>
    $('#headername').html("Self Manufacturing Expense");
    </script>
