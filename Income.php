...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="IncomeSubmit.php" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    <h3 style="color: #7088C8"><u>Income:</u></h3>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    function addField() {
        ...
        var content = '';
        content += '<div class="row" id="Income_row_' + counter + '" name="Income_row">';
