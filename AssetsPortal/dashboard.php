                                        ...
                                        <div class="row">
                                            <div class="col-4 align-self-center">
                                                <div class="icon-info"><i
                                                        class="mdi mdi-diamond-stone text-warning"></i></div>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4 align-self-center">
                                                <div class="icon-info"><i
                                                        class="mdi mdi-account-multiple text-purple"></i></div>
                                            </div>
                                            <div class="col-8 align-self-center text-right">
                                                <div class="ml-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-4 align-self-center">
                                                <div class="icon-info"><i
                                                        class="mdi mdi-playlist-check text-success"></i></div>
                                            </div>
                                            <div class="col-8 align-self-center text-right">
                                                <div class="ml-2">
                            ...
                            <div class="card-body dash-info-carousel mb-0">
                                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                            ...
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        ...
                                                        <div class="my-3"><img src="assets/images/widgets/p-1.svg"
                                                                alt="" height="103" class=""></div>
                                                        <h2 class="project-title mb-1">Marketech World</h2>
                                                        <p class="mb-1 text-muted"><span
                                                                class="mr-2 text-secondary font-14"><b>190
                                                                    Days</b></span> Tuesday, 25 July 2019</p>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Project Launch Date</h4>
                                                        <div class="my-3"><img src="assets/images/widgets/p-2.svg"
                                                                alt="" height="103" class=""></div>
                                                        <h2 class="project-title mb-1">Book My World</h2>
                                                        <p class="mb-1 text-muted"><span
                                                                class="mr-2 text-secondary font-14"><b>130
                                                                    Days</b></span> Tuesday, 25 July 2019</p>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Project Launch Date</h4>
                                                        <div class="my-3"><img src="assets/images/widgets/p-3.svg"
                                                                alt="" height="103" class=""></div>
                                                        <h2 class="project-title mb-1">Organic Farming</h2>
                                                        <p class="mb-1 text-muted"><span
                                                                class="mr-2 text-secondary font-14"><b>100
                                                                    Days</b></span> Tuesday, 25 July 2019</p>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                        ...
                                        <div class="carousel-item">
                                            <div class="row">
                                                <div class="col-12 align-self-center">
                                                    <div class="text-center">
                                                        <h4 class="mt-0 header-title text-left">Project Launch Date</h4>
                                                        <div class="my-3"><img src="assets/images/widgets/p-4.svg"
                                                                alt="" height="103" class=""></div>
                                                        <h2 class="project-title mb-1">Transfer money</h2>
                                                        <p class="mb-1 text-muted"><span
                                                                class="mr-2 text-secondary font-14"><b>85
                                                                    Days</b></span> Tuesday, 25 July 2019</p>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                        ...
                                        <!--end carousel-item-->
                                    </div><a class="carousel-control-prev" href="#carouselExampleControls" role="button"
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="morris-bar-chart" class="morris-chart project-budget-chart drop-shadow-bar">
                                </div>
                                <ul class="list-unstyled text-center text-muted mb-0 mt-2">
                                    <li class="list-inline-item"><i class="mdi mdi-album text-primary mr-2"></i>Total
                                        Budget
                                    </li>
                                    <li class="list-inline-item"><i class="mdi mdi-album mr-2 text-success"></i>Amount
                                        Used
                                    </li>
                                    <li class="list-inline-item"><i class="mdi mdi-album mr-2 text-warning"></i>Target
                                        Amount
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="list-unstyled text-center text-muted mb-0">
                                            <li class="list-inline-item font-13"><i
                                                    class="mdi mdi-album font-16 text-purple mr-2"></i>External</li>
                                            <li class="list-inline-item font-13"><i
                                                    class="mdi mdi-album font-16 text-pink mr-2"></i>Internal</li>
                                            <li class="list-inline-item font-13"><i
                                                    class="mdi mdi-album font-16 text-success mr-2"></i>Other</li>
                                        </ul>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td class="border-top-0"><img
                                                                src="assets/images/widgets/project1.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-1"> <span
                                                                class="text-info">Book My World</span></td>
                                                        <td class="border-top-0"><small
                                                                class="float-right text-muted ml-3 font-14">121h</small>
                                                            <div class="progress mt-2" style="height:5px;">
                                                                <div class="progress-bar bg-pink" role="progressbar"
                                                                    style="width: 55%; border-radius:5px;"
                                                    ...
                                                    <tr>
                                                        <td><img src="assets/images/widgets/project2.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-1"> <span
                                                                class="text-info">Organic Farming</span></td>
                                                        <td><small
                                                                class="float-right text-muted ml-3 font-14">522h</small>
                                                            <div class="progress mt-2" style="height:5px;">
                                                                <div class="progress-bar bg-secondary"
                                                                    role="progressbar"
                                                                    style="width: 66%; border-radius:5px;"
                                                    ...
                                                    <tr>
                                                        <td><img src="assets/images/widgets/project3.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-1"> <span
                                                                class="text-info">Marketech World</span></td>
                                                        <td><small
                                                                class="float-right text-muted ml-3 font-14">245h</small>
                                                            <div class="progress mt-2" style="height:5px;">
                                                                <div class="progress-bar bg-warning" role="progressbar"
                                                                    style="width: 34%; border-radius:5px;"
                                                    ...
                                                    <tr>
                                                        <td><img src="assets/images/widgets/project4.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-1"> <span
                                                                class="text-info">Transfer money</span></td>
                                                        <td><small
                                                                class="float-right text-muted ml-3 font-14">80h</small>
                                                            <div class="progress mt-2" style="height:5px;">
                            ...
                            <div class="card-body">
                                ...
                                <div class="todo-list">
                                    <div class="todo-box"><i class="remove far fa-trash-alt"></i>
                                        <div class="todo-task"><label class="ckbox"><input type="checkbox"><span>Icon
                                                    change in Redesign App</span></label></div>
                                    </div>
                                    <div class="todo-box"><i class="remove far fa-trash-alt"></i>
                                        <div class="todo-task"><label class="ckbox"><input type="checkbox"
                                                    checked=""><span>Add search button Market Research</span></label>
                                        </div>
                                    </div>
                                    <div class="todo-box"><i class="remove far fa-trash-alt"></i>
                                        <div class="todo-task"><label class="ckbox"><input type="checkbox"><span>Test
                                                    new features in tablets</span></label></div>
                                    </div>
                                    <div class="todo-box"><i class="remove far fa-trash-alt"></i>
                                        <div class="todo-task"><label class="ckbox"><input type="checkbox"
                                                    checked=""><span>Send IOS App documents</span></label></div>
                                    </div>
                                    <div class="todo-box"><i class="remove far fa-trash-alt"></i>
                                        <div class="todo-task"><label class="ckbox"><input type="checkbox"><span>Connect
                                                    API to pages</span></label></div>
                                    </div>
                                </div>
                                <div class="input-group custom-input"><input type="text"
                                        class="form-control todo-list-input" placeholder="Add task"> <span
                                        class="input-group-append"></span> <button
                                        class="btn btn-gradient-primary add-new-todo-btn">Add</button></div>
                            </div>
                            <!--end card-body-->
                        </div>
                        <!--end card-->
                                            ...
                                            <table class="table table-hover mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><img src="assets/images/users/user-2.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-2"> Kevin J. Heal</td>
                                                        <td>20/3/2018</td>
                                                        <td>5/5/2018</td>
                                                        <td><span
                                                                class="badge badge-md badge-boxed badge-soft-success">Active</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>15/7/2018</td>
                                                        <td><span
                                                                class="badge badge-md badge-boxed badge-soft-warning">Panding</span>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>Website &amp; Blog</td>
                                                        <td><img src="assets/images/users/user-4.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-2"> Hyman M. Cross
                                                        </td>
                                                        <td>21/6/2018</td>
                                                        <td>3/7/2018</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="assets/images/users/user-5.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-2"> Angelo E. Butler
                                                        </td>
                                                        <td>30/4/2018</td>
                                                        <td>1/6/2018</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="assets/images/users/user-6.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-2"> Robert C. Golding
                                                        </td>
                                                        <td>20/3/2018</td>
                                                        <td>5/5/2018</td>
                                                        <td><span
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="assets/images/users/user-8.jpg" alt=""
                                                                class="thumb-sm rounded-circle mr-2"> Phillip T. Morse
                                                        </td>
                                                        <td>8/4/2018</td>
                                                        <td>2/6/2018</td>
                                                        <td><span
                                                                class="badge badge-md badge-boxed badge-soft-danger">Complete</span>
                                                        </td>
                                    ...
                                    <div class="activity"><i class="mdi mdi-check icon-success"></i>
                                        <div class="time-item">
                                            <div class="item-info">
                                                ...
                                                <p class="text-muted font-13">Lorem ipsum dolor sit amet, consectetur
                                                    adipiscing elit. <a href="#" class="text-info">[more info]</a></p>
                                            </div>
                                        ...
                                        <div class="time-item">
                                            <div class="item-info">
                                                ...
                                                <p class="text-muted font-13">Lorem ipsum dolor sit amet. <a href="#"
                                                        class="text-info">[more info]</a></p>
                                            </div>
                                        ...
                                        <div class="time-item">
                                            <div class="item-info">
                                                ...
                                                <p class="text-muted font-13">There are many variations of passages of
                                                    Lorem Ipsum available. <a href="#" class="text-info">[more info]</a>
                                                </p>
                                            </div>
