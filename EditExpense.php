...
<head>
    <meta charset="utf-8">
    <title>Self Manufacturing Edit Expense - Dashboard</title>
...
<body>
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Self Manufacturing Edit Expense</li>
                                </ol>
                            </div>
    ...
    <script>
    $('#headername').html("Self Manufacturing Edit Expense");
    </script>
