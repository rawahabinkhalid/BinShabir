...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from mannatthemes.com/metrica/light-material-vertical/authentication/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Mar 2020 08:05:34 GMT -->

<head>
    <meta charset="utf-8">
    <title>Login - RICE MILL</title>
            ...
            <div class="auth-page">
                    ...
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <div class="text-center auth-logo-text">
                                <h4 class="mt-0 mb-3 mt-5">BIN SHABIR RICE MILL</h4>
                                <p class="text-muted mb-0">Sign in to continue to Rice Mill.</p>
                            </div>
                            <!--end auth-logo-text-->
                            <form class="form-horizontal auth-form my-4" action="logindata.php" method="post">
                                <div class="form-group">
                                    <label>Username</label>
                                    <div class="input-group mb-3"><span class="auth-form-icon"><i
                                                class="dripicons-user"></i> </span><input type="text"
                                            class="form-control" name="username" placeholder="Enter username"></div>
                                </div>
                                <!--end form-group-->
                                <div class="form-group"><label for="userpassword">Password</label>
                                    <div class="input-group mb-3"><span class="auth-form-icon"><i
                                                class="dripicons-lock"></i> </span><input type="password"
                                            class="form-control" name="userpassword" placeholder="Enter password"></div>
                                </div>
                                <!--end form-group-->
                                ...
                                <div class="form-group mb-0 row">
                                    <div class="col-12 mt-2"><button
                                            ...
                                            type="submit">Log In <i class="fas fa-sign-in-alt ml-1"></i></button></div>
                                    <!--end col-->
                                </div>
                                <!--end form-group-->
                            </form>
                ...
                <div class="account-social text-center mt-4">
                    ...
                    <ul class="list-inline mb-4">
                        <li class="list-inline-item"><a href="#" class=""><i class="fab fa-facebook-f facebook"></i></a>
                        </li>
