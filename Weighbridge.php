...
<head>
    <meta charset="utf-8">
    <title>WeighBridge - Dashboard</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="WeighBridgeSubmit.php" method="POST">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>
                                    <h3 style="color: #7088C8"><u>WeighBridge:</u></h3>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    function addField() {
        ...
        var content = '';
        content += '<div class="row" id="WeighBridge_row_' + counter + '" name="WeighBridge_row">';
        content += '    <div class="col-md-3">';
        content += '        <div class="form-group">';
        content += '            <input type="date" name="date[]" required class="form-control">';
        content += '        </div>';
        content += '    </div>';
        content += '    <div class="col-md-2">';
        content += '        <div class="form-group">';
        content += '            <input type="text" name="truck[]" required class="form-control">';
        content += '        </div>';
        content += '    </div>';
        content += '    <div class="col-md-2">';
        content += '        <div class="form-group">';
        content += '            <input type="text" name="weight[]" required id="weight" class="form-control">';
        content += '        </div>';
        content += '    </div>';
        content += '    <div class="col-md-2">';
        content += '        <div class="form-group">';
        content += '            <input type="text" name="rate[]" required id="rate" class="form-control">';
        content += '        </div>';
        content += '    </div>';
        content += '    <div class="col-md-3">';
        content += '        <div class="form-group">';
        content += '            <input type="number" name="amount[]" required id="amount" class="form-control">';
        content += '        </div>';
        content += '    </div>';
        content += '</div>';
    ...
    function delField() {
        $("#WeighBridge_row_" + counter).remove();
        if(counter == 0)
