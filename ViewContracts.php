...
<head>
    <meta charset="utf-8">
    <title>View Contracts - Dashboard</title>
...
<body>
    ...
    <script>
    $('#headername').html("View Contracts");
    </script>
    ...
    function printpage() {
        ...
        printButton.style.display = 'none';
         ...
         var printButton = document.getElementById("view_heading");
        //Set the print button visibility to 'hidden' 
        printButton.style.display = 'none';
