...
<head>
    <meta charset="utf-8">
    <title>Tool Mill Contract - Dashboard</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">ToolMillContract</li>
                                </ol>
                            </div>
                ...
                <form action="ToolMillContractSubmit.php" method="POST">
                    <br><br>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Contract Type:</label>
                                <input class="form-control" name="contracttype" value="Sales"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Price / KG: <span class="text-danger">*</span></label>
    ...
    <script>
    $('#headername').html("Tool Mill Contract");
    </script>
</body>
