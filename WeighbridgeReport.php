...
<head>
    <meta charset="utf-8">
    <title>Weigh Bridge Report - Dashboard</title>
...
<body>
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Weigh Bridge Report</li>
                                </ol>
                            </div>
    ...
    <script>
    $('#headername').html("Weigh Bridge Report");
    </script>
    ...
    $('#daterangeBtn').on('click', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'get_Weigh_Bridge_Report_By_Date.php',
